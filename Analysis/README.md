...
The R scripts are provided as markdown documents as well as knitted html reports to provide the exact run parameters. All R analyses were performed in R 4.3.3 unless otherwise stated. For the GSEA scripts, as the rMATS results returned no significant events those code chunks were removed prior to upload. 
